...
<script lang="ts" setup name="EfFormItem">
import {
  computed,
  inject,
  nextTick,
...
import { clone, isEqual, get, set } from 'lodash';
import { refDebounced } from '@vueuse/core';
import { addUnit, ensureArray, isBoolean, isFunction } from '../../utils';

import { formContextKey, formItemContextKey } from '../../token';
import { useId, useSize, useNamespace } from '../../hooks';
...
const propString = computed(() => {
  ...
  return Array.isArray(props.prop) ? props.prop.join('.') : props.prop;
});
...
watch(
  ...
  (val: FormItemValidateState) => setValidationState(val || '')
);
