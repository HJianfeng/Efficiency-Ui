...
describe('Checkbox', () => {
  test('create', async () => {
    ...
    expect(wrapper.classes()).toContain('ef-checkbox');
  ...
  test('label', async () => {
    ...
    const checkbox = wrapper.find('.ef-checkbox');
...
describe('check-button', () => {
  test('create', async () => {
    ...
    expect(wrapper.classes()).toContain('ef-checkbox-button');
    await wrapper.find('input[type="checkbox"]')['setChecked'](true);
    expect(wrapper.classes()).toContain('is-checked');
    await wrapper.find('input[type="checkbox"]')['setChecked'](false);
    expect(wrapper.classes('is-checked')).toBe(false);
  ...
  test('button group props', () => {
    ...
    expect(
      checkbox.find('.ef-checkbox-button__inner').attributes('style')
  ...
  test('button group tag', () => {
    ...
    expect(wrapper.find('tr').classes('ef-checkbox-group')).toBeTruthy();
  });
  ...
  describe('checked prop', () => {
    ...
    test('checked', async () => {
      ...
      expect(wrapper.find('.ef-checkbox').classes()).not.contains('is-checked');
    });
  });
  ...
  describe('form item accessibility integration', () => {
    test('checkbox, no label, automatic label attachment', async () => {
      ...
      const formItem = await wrapper.findComponent(FormItem);
      const checkbox = await wrapper.findComponent(Checkbox);
      const formItemLabel = formItem.find('.ef-form-item__label');
      const checkboxInput = checkbox.find('.ef-checkbox__original');
    ...
    test('checkbox with label, form item is group', async () => {
      ...
      const formItem = await wrapper.findComponent(FormItem);
      const checkbox = await wrapper.findComponent(Checkbox);
      const checkboxLabel = checkbox.find('.ef-checkbox__label');
      const checkboxInput = checkbox.find('.ef-checkbox__original');
