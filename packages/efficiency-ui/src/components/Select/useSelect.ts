...
import { useFormItem, useNamespace, useSize, EVENT_CODE } from '../../hooks';
  ...
  const resetInputHeight = () => {
    ...
    nextTick(() => {
      ...
      states.tagInMultiLine =
        Number.parseFloat(input.style.height) >= sizeInMap;
