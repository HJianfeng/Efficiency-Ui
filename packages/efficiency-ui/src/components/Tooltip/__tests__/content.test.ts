...
import { usePopperContainer } from '../../../hooks';
import EfTooltipContent from '../content.vue';
...
describe('<EfTooltipContent />', () => {
  ...
  const createComponent = (props = {}, provides = {}) => {
    const wrapper = mount(
      {
        ...
        template: `<ef-tooltip-content><slot /></ef-tooltip-content>`,
        setup() {
          usePopperContainer();
        }
      },
    ...
    return wrapper.findComponent(EfTooltipContent);
  };
