<template>
  <ef-popper ref="popperRef" :role="role">
    <ef-tooltip-trigger
      :disabled="disabled"
      :trigger="trigger"
    ...
    >
      ...
      <ef-popper-arrow v-if="compatShowArrow" :arrow-offset="arrowOffset" />
    </EfPopperContent>
  </ef-popper>
</template>
...
import { Popper as EfPopper, usePopperProps, EfPopperArrow } from '../Popper';
...
import EfTooltipTrigger from './trigger.vue';
...
export default defineComponent({
  ...
  setup(props, { emit }) {
    ...
    const id = useId();
    const popperRef = ref<InstanceType<typeof EfPopper> | null>(null);
