...
import makeScroll from '../../../test-util/make-scroll';
import defineGetter from '../../../test-util/define-getter';
...
describe('ScrollBar', () => {
  test('vertical', async () => {
    ...
    const scrollDom = wrapper.find('.ef-scrollbar__wrap').element;
  ...
  test('should render height props', async () => {
    ...
    expect(wrapper.find('.ef-scrollbar__wrap').attributes('style')).toContain(
      'height: 204px;'
    );
  });
  ...
  test('should render always props', async () => {
    ...
    expect(wrapper.find('.ef-scrollbar__bar').attributes('style')).toBeFalsy();
  });
  ...
  test('should render tag props', async () => {
    ...
    expect(
      wrapper.find('.ef-scrollbar__view').element instanceof HTMLUListElement
    ).toBeTruthy();
  });
  ...
  test('should render wrap-class props', async () => {
    ...
    expect(wrapper.find('.ef-scrollbar__wrap').classes()).toContain(wrapClass);
  });
  ...
  test('should render view-style props', async () => {
    ...
    expect(wrapper.find('.ef-scrollbar__view').attributes('style')).toContain(
      viewStyle
    );
  });
  ...
  test('should render view-class props', async () => {
    ...
    expect(wrapper.find('.ef-scrollbar__view').classes()).toContain(viewClass);
  });
});
